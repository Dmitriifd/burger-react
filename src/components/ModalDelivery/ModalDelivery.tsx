...
export const ModalDelivery = () => {
  ...
  const closeModalHandler = ({ target, currentTarget }: MouseEvent) => {
          ...
          <form className={style.form} id="delivery" onSubmit={handleSubmit}>
            <fieldset className={style.fieldset}>
              <label className={style.form_label}>
                ...
                />
                {form.errors.name && <span>Имя обязательно для заполнения</span>}
              </label>
              <label className={style.form_label}>
                <input
                  className={style.input}
            ...
            {/* показать доп поля если выбран delivery */}
